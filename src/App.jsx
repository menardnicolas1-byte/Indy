...
1. Via la SCPP (si tu es producteur avec SIRET)
...
1. Vérifie ton éligibilité (statut, type de projet)
1. Prépare : dossier artistique, devis, planning, CV artistique
1. Dépose avant la date limite trimestrielle (publiée sur le site)
...
1. Présente ton projet avec ancrage local fort
1. Dossier artistique complet + budget prévisionnel
1. Réponse sous 3-5 mois
...
1. Dossier artistique + démo + lettre de motivation personnalisée
1. Délai de réponse : 1-3 mois
...
1. Clique “Créer mon auto-entreprise”
1. Remplis : identité, activité (code APE), adresse
1. Reçois ton SIRET sous 48-72h par email
1. Commence à facturer !
...
1. Déposer le capital (1€ minimum pour SAS)
1. Publier une annonce légale (~150€)
...
1. Chant BV — [si applicable]
1. Guitare — DI ou ampli micro
1. Basse — DI
1. Kick
1. Caisse claire
1. Overhead
...
// — STYLES ——————————————————————
const CSS = `@import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Bebas+Neue&display=swap'); *{box-sizing:border-box;margin:0;padding:0} ::-webkit-scrollbar{width:3px;height:3px} ::-webkit-scrollbar-thumb{background:#1A1A1A;border-radius:2px} input,textarea,select{width:100%;background:#111;border:1px solid #1E1E1E;color:#F0EDE8;font-family:'Inter',sans-serif;font-size:12px;padding:11px 13px;border-radius:6px;outline:none;-webkit-appearance:none;transition:border-color 0.2s} input:focus,textarea:focus{border-color:#FF6B3555} input::placeholder,textarea::placeholder{color:#555} input[type=date]{color-scheme:dark} textarea{resize:none} @keyframes fadeUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}} @keyframes fadeIn{from{opacity:0}to{opacity:1}} @keyframes pulse{0%,100%{opacity:0.3}50%{opacity:1}} @keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-5px)}} @keyframes glow{0%,100%{box-shadow:0 0 20px #FF6B3515}50%{box-shadow:0 0 35px #FF6B3530}} @keyframes spin{to{transform:rotate(360deg)}} .fu{animation:fadeUp 0.3s ease forwards} .fi{animation:fadeIn 0.25s ease forwards} .btn{background:linear-gradient(135deg,#FF6B35 0%,#FF8550 100%);border:none;color:#000;font-family:'Inter',sans-serif;font-size:11px;letter-spacing:2px;text-transform:uppercase;padding:13px 20px;border-radius:8px;cursor:pointer;font-weight:500;transition:all 0.25s;width:100%;box-shadow:0 4px 14px #FF6B3530} .btn:hover{transform:translateY(-1px);box-shadow:0 6px 20px #FF6B3555} .btn:disabled{background:#1A1A1A;color:#333;box-shadow:none;transform:none;cursor:not-allowed} .btn-o{background:none;border:1px solid #1E1E1E;color:#555;font-family:'Inter',sans-serif;font-size:11px;letter-spacing:2px;text-transform:uppercase;padding:11px 18px;border-radius:5px;cursor:pointer;transition:all 0.2s} .btn-o:hover{border-color:#333;color:#888} .pill{font-size:9px;letter-spacing:1px;padding:2px 8px;border-radius:20px;display:inline-flex;align-items:center;gap:4px;text-transform:uppercase} .chip{display:inline-flex;font-size:9px;color:#555;background:#111;padding:2px 8px;border-radius:20px} .card{background:linear-gradient(180deg,#0F0F0F 0%,#0B0B0B 100%);border-radius:12px;border:1px solid #1A1A1A;transition:all 0.25s;box-shadow:0 2px 8px rgba(0,0,0,0.3)} .card:hover{border-color:#2A2A2A;box-shadow:0 4px 16px rgba(0,0,0,0.5)} .panel{position:fixed;inset:0;background:#000000EE;z-index:200;display:flex;flex-direction:column;animation:fadeIn 0.2s ease} .pin{background:#080808;flex:1;overflow-y:auto;animation:fadeUp 0.25s ease;border-top:2px solid} .tab{flex:1;background:none;border:none;border-bottom:2px solid transparent;color:#444;font-family:'Inter',sans-serif;font-size:9px;letter-spacing:1px;padding:10px 0;cursor:pointer;transition:all 0.2s;text-transform:uppercase} .tab.on{color:#FF6B35;border-bottom-color:#FF6B35} .nav{display:flex;flex-direction:column;align-items:center;gap:3px;padding:7px 0;cursor:pointer;flex:1;background:none;border:none;font-family:'Inter',sans-serif;transition:all 0.2s} a.lnk{display:block;text-align:center;padding:12px;border-radius:5px;font-family:'Inter',sans-serif;font-size:11px;letter-spacing:2px;text-transform:uppercase;text-decoration:none;transition:all 0.2s}`;
